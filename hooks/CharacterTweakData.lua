...
function CharacterTweakData:_init_fbi(presets)
	...
	--Custom Cartel
	self.fbi_cartel_base = deep_clone(self.fbi)
	self.fbi_cartel_base.HEALTH_INIT = 10
	...
	-- Light Cartel
	self.fbi_cartel_light = deep_clone(self.fbi_cartel_base)
	table.insert(self._enemy_list, "fbi_cartel_light")
	
	-- Medium Cartel
	self.fbi_cartel_medium = deep_clone(self.fbi_cartel_base)
	self.fbi_cartel_medium.HEALTH_INIT = 12
	table.insert(self._enemy_list, "fbi_cartel_medium")
	
	-- Heavy Cartel
	self.fbi_cartel_heavy = deep_clone(self.fbi_cartel_base)
	self.fbi_cartel_heavy.HEALTH_INIT = 32
	self.fbi_cartel_heavy.headshot_dmg_mul = 3
	table.insert(self._enemy_list, "fbi_cartel_heavy")
